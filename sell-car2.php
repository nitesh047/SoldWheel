                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <label class="c-dark">Name</label>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Your name" />
                                        </div>
                                    </div> 
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <label class="c-dark">Email</label>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="Your emial" />
                                        </div>
                                    </div> 
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <label class="c-dark">Phone</label>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="xxxxx - xxxxx" />
                                        </div>
                                    </div> 
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <label class="c-dark">City</label>
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="City name" />
                                        </div>
                                    </div> 
                                    <div class="col-12 col-sm-6 col-lg-4">
                                        <label class="c-dark">Postal Code</label>
                                        <div class="form-group">
                                    ...
                                    <div class="col-12 col-sm-4 col-lg-2 mr-auto mt-3 mt-sm-0">
                                        <a href="sell-car.html" class="btn btn-secondary btn-md btn-block text-uppercase">Back</a>  
                                    </div>
                                    <div class="col-12 col-sm-4 col-lg-2 ml-auto mt-3 mt-sm-0">
                                        <a href="sell-car3.html" class="btn btn-primary btn-md btn-block text-uppercase">Next</a>  
                                    </div>
                                </div>
                            </div>
                        </div>
