...
<head>
        ...
        <title>Car List- SoldWheel</title>  
                    ...
                    <div class="col-12 col-lg-12">
                        <div class="row mb-4">
                            <div class="col-12 col-md-5 col-xl-6 align-self-center">
                                <p class="mb-0">8 Vehicles Matching</p>
                            </div>
                                    ...
                                    <div class="listing-filter">
                                        <ul class="nav nav-pills justify-content-md-end mb-0">
                                            <li class="nav-item mr-2">
                                                <a class="nav-link redial-light rounded active" href="#"><i class="fa fa-th-list"></i></a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link redial-light rounded" href="#"><i class="fa fa-th"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12 col-lg-4 h-283">
                                    <div class="position-relative">
                                        <a href="#">
                                            ...
                                            <div class="holder-image">
                                                <img src="dist/images/img5.jpg" alt="" class="img-fluid d-none" />
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                <div class="col-12 col-lg-5 align-self-center">
                                    <div class="p-4 p-lg-0">
                                        ...
                                        <a href="listing-details.html" class="btn btn-outline-primary text-uppercase btn-lg c-font-weight-700" tabindex="-1">View Details</a>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-4 h-283">
                                    <div class="position-relative">
                                        <a href="#">
                                            <div class="background-image-maker rounded-left h-283"></div>
                                            <div class="holder-image">
                                                <img src="dist/images/img6.jpg" alt="" class="img-fluid d-none" />
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-lg-4 h-283">
                                    <div class="position-relative">
                                        <a href="#">
                                            <div class="background-image-maker rounded-left h-283"></div>
                                            <div class="holder-image">
                                                <img src="dist/images/img10.jpg" alt="" class="img-fluid d-none" />
                                            </div>
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="card car-listing-full">
                            <div class="row">
                                <div class="col-12 col-lg-4 h-283">
                                    <div class="position-relative">
                                        <a href="#">
